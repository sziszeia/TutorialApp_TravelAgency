class CreditCardsController < ApplicationController
  ...
  def update
    @credit_card.exp_date = params[:exp_date][:year].to_s + "/" + params[:exp_date][:month]
    respond_to do |format|
  ...
  private
    ...
    def credit_card_params
      params.require(:credit_card).permit(:number, :exp_date, :name_on_card, :organasation, :customer_id)
    end
end
